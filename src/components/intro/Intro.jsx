import './Intro.css'
import Me from '../../img/profilephnn.png'
        ...
        <div className='i'>
            <div className='i-left'>
                <div className="i-left-wrapper">
                    ...
                    <h1 className="i-name">Nicolas Siciliano</h1>
                    <div className="i-title">
                        <div className="i-title-wrapper">
                            <div className="i-title-item">Front-End Engineer</div>
                            <div className="i-title-item">React/Next Developer</div>
                            <div className="i-title-item">Web3 Developer</div>
